# 🚀 FastAPI Monorepo Copier Template
...
```bash
uvx copier copy --trust gh:dmitriypru/fastapi-uv-monorepo-template my-monorepo
cd my-monorepo
```
...
```bash
uvx copier copy --trust gh:dmitriypru/fastapi-uv-monorepo-template . 
```
